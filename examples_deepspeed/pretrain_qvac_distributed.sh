...
# Accept arguments
WANDB_PROJECT=${1:-"pretrain-llama2"}
WANDB_EXP_NAME=${2:-"exp0"}

######################################
# Change the below configurations here
HOME_DIR=/root
BASE_SRC_PATH=${HOME_DIR}/Megatron-DeepSpeed
DS_CONFIG=${BASE_SRC_PATH}/deepspeed.json
BASE_DATA_PATH=${BASE_SRC_PATH}/dataset

DATASET_1="${BASE_DATA_PATH}/bookcorpus_train_1m_text_sentence"
DATASET="1 ${DATASET_1}"

INPUT_PATH=${BASE_SRC_PATH}/input
OUTPUT_PATH=${BASE_SRC_PATH}/output
CHECKPOINT_PATH=${OUTPUT_PATH}/checkpoints
TOKENIZER_PATH=${INPUT_PATH}/tokenizer.model # offical llama tokenizer.model
